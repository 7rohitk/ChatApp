    ...
    text-white ${selectedUser ? "max-md:hidden" : ''}`}>
      ...
      <div className='pb-5'>
        <div className='flex justify-between items-center'>
          ...
          <div className="relative py-2 group"> 
            ...
            bg-[#1e3c30] border border-gray-600 text-gray-100 hidden
            group-hover:block'>
        ...
        <div className='bg-[#1c342d] rounded-full flex items-center gap-2 py-3 px-4 mt-5'>
      ...
      <div className='flex flex-col'>
        {filteredUsers.map((user, index)=>(
            ...
            flex justify-center items-center rounded-full bg-green-500/50'>{unseenMessages[user._id]}</p>}
  </div> 
))}
